        ...
        >
          ...
          <div className="bg-white rounded-2xl overflow-hidden shadow-lg">
            <div className="relative overflow-hidden">
              <img
                src={mainImage}
                alt="Corporate & Formal Event Theme"
          ...
          <div className="flex justify-center space-x-4">
            {smallImages.map((image, index) => (
              ...
              >
                <img
                  src={image}
                  alt={`Corporate Event Theme Preview ${index + 1}`}
          ...
          <div className="bg-white rounded-2xl p-6 md:p-8 shadow-lg">
            <h3 className="text-2xl font-bold mb-4">Corporate & Formal Event Theme</h3>
            <p className="text-gray-700 mb-6">
              Elevate your corporate or formal event with our exclusive Corporate & Formal Event Theme. Perfect for conferences, seminars, product launches, or award ceremonies, our theme includes professional setups, elegant decorations, and a seamless experience. Whether it's a business meeting or a formal gala, we ensure a sophisticated and memorable event.
            </p>
            <p className="text-gray-700 mb-6">
              <strong>Theme Includes:</strong>
              <ul className="list-disc list-inside mt-2">
                <li>Professional and elegant decorations (backdrops, lighting, and branding)</li>
                <li>Customized stage and seating arrangements</li>
                <li>High-quality audio-visual equipment for presentations</li>
                <li>Networking lounge with comfortable seating</li>
                <li>Dedicated event coordinator for seamless execution</li>
                <li>On-site technical support for smooth operations</li>
              </ul>
            </p>
            <p className="text-gray-700 mb-6">
              <strong>Additional Services:</strong>
              <ul className="list-disc list-inside mt-2">
                <li>Catering options (formal dining, buffet, or cocktail setups)</li>
                <li>Entertainment packages (live bands, keynote speakers, or performers)</li>
                <li>Custom theme requests to match your corporate branding</li>
              </ul>
            </p>
            <div className="mt-6">
              <div className="flex items-center text-gray-700">
                <span className="font-bold">Total Amount With Theme is: ₹2,00,000</span>
